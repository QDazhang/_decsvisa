...
# Proteox cmd uri is required for DECS verisons 1.7
...
Proteox_cmd_uri = {
    ...
    "get_CP"            : "oi.decs.proteox.3CL_CP_01.state",
    "set_CP"            : "oi.decs.proteox.3CL_CP_01.state",
    "get_FP"            : "oi.decs.proteox.3CL_FP_01.state",
    "set_FP"            : "oi.decs.proteox.3CL_FP_01.state",
    "get_AV05"          : "oi.decs.proteox.3CL_GHS.3CL_AV_05.state",
    "set_AV01"          : "oi.decs.proteox.3CL_GHS.3CL_AV_01.state",
    "set_AV02"          : "oi.decs.proteox.3CL_GHS.3CL_AV_02.state",
    "set_AV03"          : "oi.decs.proteox.3CL_GHS.3CL_AV_03.state",
    "set_AV04"          : "oi.decs.proteox.3CL_GHS.3CL_AV_04.state",
    "set_AV05"          : "oi.decs.proteox.3CL_GHS.3CL_AV_05.state",
    "set_AV06"          : "oi.decs.proteox.3CL_GHS.3CL_AV_06.state",
    "set_AV07"          : "oi.decs.proteox.3CL_GHS.3CL_AV_07.state",
    "set_AV08"          : "oi.decs.proteox.3CL_GHS.3CL_AV_08.state",
    "get_pulse_AV05"    : "oi.decs.proteox.3CL_GHS.3CL_AV_05.pulse",
    "get_PRXS"          : "oi.decs.proteox.state",
    "set_PRXS"          : "oi.decs.proteox.state",
...
# Proteox_cmd_uri_v0 for DECS versions 0.5 and below
Proteox_cmd_uri_v0:  dict[str, str]
Proteox_cmd_uri_v0 = {
    "get_SAMPLE_T"      : "oi.decs.temperature_control.DRI_MIX_CL.DRI_MIX_S.temperature",
    "set_SAMPLE_T"      : "oi.decs.temperature_control.DRI_MIX_CL.setpoint",
    "get_MC_T"          : "oi.decs.temperature_control.DRI_MIX_CL.DRI_MIX_S.temperature",
...
Teslatron_cmd_uri = {
    ...
    "set_AV915"          : "oi.decs.teslatron.C-AV915.state",
    "set_AV911"          : "oi.decs.teslatron.C-AV911.state",
    "set_AV908"          : "oi.decs.teslatron.C-AV908.state",
    "set_AV903"          : "oi.decs.teslatron.C-AV903.state",
    "get_AV915"          : "oi.decs.teslatron.C-AV915.state",
    "get_AV911"          : "oi.decs.teslatron.C-AV911.state",
    "get_AV908"          : "oi.decs.teslatron.C-AV908.state",
    ...
    "set_CIRC_TARGET"    : "oi.decs.teslatron.set_circulate_target_temperature",
