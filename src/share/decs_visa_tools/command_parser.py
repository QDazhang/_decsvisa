...
# from .command_dictionary import Proteox_cmd_uri_V3 as cmd_uri
...
def decs_command_parser(cmd: str) -> tuple [str, list]:
    ...
    # elif "3CL_AV" in uri and uri.endswith("set_valve_open_percentage") or uri.endswith("set_target_position") or uri.endswith("pulse_width") or uri.endswith("pulse"):
    elif "proteox" in uri and uri.endswith("state"):
